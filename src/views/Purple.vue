	...
	<div>
		<div id="email-sig-wrap" ref="sigwrap">
			...
			<div style="float: left; font-size: 16px; width: auto; height: auto; padding: 3px 15px; vertical-align: top">
				...
				<div v-if="mobile != 'false'" style="font-family: 'Helvetica', sans-serif; font-size: 10pt; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 5px;display: inline-block;"><span style="width: 10px;display: inline-block;text-align: center; color: #7902df; font-weight: 600;">M</span><span style="color: #7902df; font-weight: 600;padding-left:2px;">:</span> <a :href="mlink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{mobile}}</span></a></div>
				<div v-if="office !== 'false'" style="font-family: 'Helvetica', sans-serif; font-size: 10pt; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 5px;display: inline-block;"><span style="width: 10px;display: inline-block;text-align: center; color: #7902df; font-weight: 600;margin-left: 5px;">O</span><span style="color: #7902df; font-weight: 600;padding-left:2px;">:</span> <a :href="olink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{office}}</span></a></div>
				<div style="font-family: sans-serif; font-size: 12px; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 5px;"><span style="width: 10px;display: inline-block;text-align: center; color: #7902df; font-weight: 600;">E</span><span style="color: #7902df; font-weight: 600;padding-left:2px;">:</span> <a :href="elink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{email}}</span></a></div>
