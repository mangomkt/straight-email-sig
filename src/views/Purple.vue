	...
	<div>
		<div id="email-sig-wrap" ref="sigwrap">
			...
			<div style="float: left; font-size: 16px; width: auto; height: auto; padding: 3px 0px; vertical-align: top">
				...
				<div v-if="mobile != 'false'" style="font-family: 'Helvetica', sans-serif; line-height:1.3; font-size: 10pt; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 0px;display: inline-block;margin-right: 5px;"><span style="width: 14px;display: inline-block;text-align: center; color: #7902df; font-weight: 600;">M</span><span style="color: #7902df; font-weight: 600;padding-left:0px;">:</span> <a :href="mlink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{mobile}}</span></a></div>
				<div v-if="office !== 'false'" style="font-family: 'Helvetica', sans-serif; font-size: 10pt; line-height:1.3; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 0px;display: inline-block;"><span style="width: 14px;display: inline-block;text-align: center; color: #7902df; font-weight: 600;">O</span><span style="color: #7902df; font-weight: 600;padding-left:0px;">:</span> <a :href="olink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{office}}</span></a></div>
				<div style="font-family: sans-serif; font-size: 12px; font-weight: 400; color: #222; line-height:1.3; letter-spacing: 1px; padding-top: 0px;"><span style="width: 14px;display: inline-block;text-align: center; color: #7902df; font-weight: 600;">E</span><span style="color: #7902df; font-weight: 600;padding-left:0px;">:</span> <a :href="elink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{email}}</span></a></div>
				<div style="font-family: sans-serif;     font-size: 12px; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 15px;">
					<a href="http://www.facebook.com/straightortho/" target="_blank" style="text-decoration: none; display: inline-block;padding: 0px; margin-right:2px;padding-left: 1px;"><img src="./icons/social-20-min.png" style="max-height: 25px; display: block;"></a>
					<a href="https://twitter.com/straightwires" target="_blank" style="text-decoration: none; display: inline-block;padding: 0px; margin: 0 4px 0 0;"><img src="./icons/social-21-min.png" style="max-height: 25px; display: block;"></a>
					<a href="https://www.youtube.com/channel/UCmzg5cl_jDqtAdnnUOIdPoA" target="_blank" style="text-decoration: none; display: inline-block;padding: 0px; margin: 0 4px 0 0;"><img src="./icons/social-22-min.png" style="max-height: 25px; display: block;"></a>
					<a href="https://www.instagram.com/straightconsulting/" target="_blank" style="text-decoration: none; display: inline-block;padding: 0px; margin: 0 4px 0 0;"><img src="./icons/social-23-min.png" style="max-height: 25px; display: block;"></a>
					<a href="https://www.linkedin.com/company/straight-consulting" target="_blank" style="text-decoration: none; display: inline-block;padding: 0px; margin: 0 2px;"><img src="./icons/social-19-min.png" style="max-height: 25px; display: block;"></a>
				</div>
			</div>
...
export default {
  ...
  methods: {
	...
	download: function() {
		this.copy = this.$refs.sigwrap;
		this.downloadCreate("straight-purple-email-signature.html",this.copy.innerHTML);
	}
  }
}
</script>
