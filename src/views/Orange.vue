	...
	<div>
		<div id="email-sig-wrap" ref="sigwrap">
			...
			<div style="float: left; font-size: 16px; width: auto; height: auto; padding: 3px 0px; vertical-align: top">
				...
				<div v-if="mobile != 'false'" style="font-family: 'Helvetica', sans-serif; font-size: 10pt; line-height:1.3; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 0px;display: inline-block;margin-right: 5px;"><span style="width: 14px;display: inline-block;text-align: center; color: #ff6000; font-weight: 600;">M</span><span style="color: #ff6000; font-weight: 600;padding-left:0px;">:</span> <a :href="mlink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{mobile}}</span></a></div>
				<div v-if="office !== 'false'" style="font-family: 'Helvetica', sans-serif; font-size: 10pt; line-height:1.3; font-weight: 400; color: #222; letter-spacing: 1px; padding-top: 0px;display: inline-block;"><span style="width: 14px;display: inline-block;text-align: center; color: #ff6000; font-weight: 600;">O</span><span style="color: #ff6000; font-weight: 600;padding-left:0px;">:</span> <a :href="olink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{office}}</span></a></div>
				<div style="font-family: sans-serif; font-size: 12px; font-weight: 400; color: #222; line-height:1.3; letter-spacing: 1px; padding-top: 0px;"><span style="width: 14px;display: inline-block;text-align: center; color: #ff6000; font-weight: 600;">E</span><span style="color: #ff6000; font-weight: 600;padding-left:0px;">:</span> <a :href="elink" style="text-decoration: none; color: #222;"><span style="display: inline-block; text-decoration: none;">{{email}}</span></a></div>
...
export default {
  ...
  methods: {
	...
	download: function() {
		this.copy = this.$refs.sigwrap;
		this.downloadCreate("straight-orange-email-signature.html",this.copy.innerHTML);
	}
  }
}
</script>
